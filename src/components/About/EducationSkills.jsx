      ...
      {activeSection === 'skills' && (
        ...
        <div  className="about__skills-wrapper">
          ...
          <div className="about__skills-sides">
            <div className="about__skills-left">
              <li className="about__skills-item">
                <img className="about__skills-img" src={javascript} alt="javascript logo" />
                <h3 className="about__skills-name">JavaScript</h3></li>
              <li className="about__skills-item">
                <img className="about__skills-img" src={reactLogo} alt="react logo" />
                <h3 className="about__skills-name">React</h3></li>
              <li className="about__skills-item">
                <img className="about__skills-img" src={node} alt="node logo" />
                <h3 className="about__skills-name">Node.js</h3></li>
              <li className="about__skills-item">
                <img className="about__skills-img" src={express} alt="express logo" />
                <h3 className="about__skills-name">Express.js</h3></li>
              <li className="about__skills-item">
                <img className="about__skills-img" src={sql} alt="sql logo" />
                <h3 className="about__skills-name">mySQL/SQLite</h3></li>
              <li className="about__skills-item">
                <img className="about__skills-img" src={python} alt="python logo" />
                <h3 className="about__skills-name">Python</h3></li>
            </div>
            <div className="about__skills-right">
              <li className="about__skills-item">
                <img className="about__skills-img" src={django} alt="django logo" />
                <h3 className="about__skills-name">Django</h3></li>
                <li className="about__skills-item">
                <img className="about__skills-img" src={postman} alt="postman logo" />
                <h3 className="about__skills-name">Testing</h3></li>
              <li className="about__skills-item">
                <img className="about__skills-img" src={sass} alt="sass logo" />
                <h3 className="about__skills-name">SASS</h3></li>
              <li className="about__skills-item">
                <img className="about__skills-img" src={api} alt="api logo" />
                <h3 className="about__skills-name">RESTFUL APIs</h3></li>
              <li className="about__skills-item">
                <img className="about__skills-img" src={auth} alt="authentication logo" />
                <h3 className="about__skills-name">Authentication</h3></li>
              <li className="about__skills-item">
                <img className="about__skills-img" src={deploy} alt="deployment logo" />
                <h3 className="about__skills-name">Basic Deployment</h3></li>
              </div>
            </div>
        </div>
